...
CALIBR_ECAL_BARREL_INPUT = sys.argv[7]
...
CALIBR_ECAL_ENDCAPCORR = sys.argv[8]

CALIBR_HCAL_BARREL = sys.argv[9]
CALIBR_HCAL_ENDCAP = sys.argv[10]
CALIBR_HCAL_OTHER = sys.argv[10]

MHHHE = sys.argv[12]

Slcio_Path = sys.argv[13]

Slcio_Format = sys.argv[14]

Gear_File_And_Path = sys.argv[15]

Pandora_Settings_File = sys.argv[16]

ECalGeVToMIP = sys.argv[17]
HCalGeVToMIP = sys.argv[18]
MuonGeVToMIP = sys.argv[19]

HCALBarrelTimeWindowMax = sys.argv[20]
HCALEndcapTimeWindowMax = sys.argv[21]
ECALBarrelTimeWindowMax = sys.argv[22]
ECALEndcapTimeWindowMax = sys.argv[23]
dd4hep_compactxml_File= sys.argv[24]
